...
const Home: React.FC<{ onAddToCart: (p: Product) => void }> = ({ onAddToCart }) => {
  ...
  // Hero Section Images
  const heroImages = [
    "https://res.cloudinary.com/dgabaplay/image/upload/v1768328481/gold-jewelry-with-gems-showcase_i59tvt.jpg",
  ...
  useEffect(() => {
    ...
    // Continuous loop for hero images (change every 5 seconds)
  ...
  return (
    <div className="bg-white text-gray-900">
      ...
      {/* Hero Section with Animated Image Loop */}
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <h1 className="text-6xl md:text-8xl font-serif mb-8 leading-tight tracking-tight">A Legacy of Grace</h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Link to="/products?category=Sarees" className="bg-white text-gray-900 px-10 py-4 font-bold text-xs uppercase tracking-widest hover:bg-maroon hover:text-white transition-all">
              Explore Sarees
            </Link>
            <Link to="/products" className="bg-white text-gray-900 px-10 py-4 font-bold text-xs uppercase tracking-widest hover:bg-maroon hover:text-white transition-all">
              The Jewellery Box
            </Link>
          </div>
        </div>
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 space-y-4">
          <div>
            ...
            <h2 className="text-6xl font-serif text-gray-900 font-bold">The Saree Room</h2>
          </div>
          <Link to="/products?category=Sarees" className="group flex items-center space-x-2 text-xs font-bold uppercase tracking-widest text-maroon">
        ...
        {loading ? (
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-10">
            {[1,2,3,4].map(i => <div key={i} className="aspect-[3/4] bg-gray-50 animate-pulse rounded-[2rem]"></div>)}
          </div>
        ) : (
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-10">
      ...
      <section className="py-24 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl font-serif text-gray-900 font-bold mb-4">New Arrivals</h2>
      ...
      {/* Section 3: Buy 2 Get 1 FREE */}
      <section className="py-10 px-4 bg-[#0a1128] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-20">
            ...
            <h2 className="text-6xl md:text-8xl font-serif font-bold mb-6 tracking-tight">Buy 2 Get 1 FREE</h2>
            <p className="text-white/60 max-w-2xl mx-auto italic font-serif text-lg md:text-xl">
            ...
            {offerShowcaseProds.map(product => (
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                  ...
                  <h3 className="text-xl md:text-2xl font-serif font-bold leading-tight group-hover:text-gold transition-colors">{product.category}</h3>
                </div>
              </Link>
            ))}
          </div>
          ...
          <div className="mt-20 text-center">
            <Link to="/products" className="inline-block border-2 border-white/20 px-12 py-5 rounded-full text-xs font-bold uppercase tracking-[0.3em] hover:bg-white hover:text-[#0a1128] transition-all">
              Curate Your Set
            </Link>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <h2 className="text-4xl font-serif text-gray-900 font-bold mb-8 italic">"Heritage Reimagined"</h2>
          <p className="text-xl text-gray-600 leading-relaxed font-serif italic max-w-2xl mx-auto">
